    ...
    <section id="service">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                 <div>
                     <th colspan="2" style="color: blue">Create Book Position</th>
                 </div>
                    <div>
                        <p style="color: red">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <a href="/BookPositionServlet"><button type="button" class="btn btn-danger">Back to list</button></a>
                    </td>
                </tr>
                </tbody>
            </table>
