        ...
        <div class="table-wrapper">
            ...
            <form method="post">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <div>
                            <th colspan="2" style="color: blue">The Detail Information Of Product</th>
                        </div>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <th style="color: #1f1818">ID</th>
                        <td>${requestScope["views"].getId()}</td>
                    </tr>
                    <tr>
                        <th style="color: #1f1818">Name</th>
                        <td>${requestScope["views"].getName()}</td>
                    </tr>
                    <tr>
                        <th style="color: #1f1818">Quantity</th>
                        <td>${requestScope["views"].getQuantity()}</td>
                    </tr>
                    <tr>
                        <th style="color: #1f1818">Position</th>
                        <td>${requestScope["views"].getPosition()}</td>
                    </tr>
                    <tr>
                        <th style="color: #1f1818">QuantityNow</th>
                        <td>${requestScope["views"].getQuantityNow()}</td>
                    </tr>
                    <tr>
                        <th style="color: #1f1818">Amount</th>
                        <td>${requestScope["views"].getQuantity() -requestScope["views"].getQuantityNow()}</td>
                    </tr>
                    </tbody>
                </table>
            </form>
