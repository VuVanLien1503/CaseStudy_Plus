...
<div class="container">
    <nav class="navbar">
        <ul>
            ...
            <li><a href="/ProducerServlet?action=create">Create Producer</a></li>
        </ul>
    </nav>
    <section id="home">
            ...
            <table class="table table-striped table-hover">
                ...
                <c:forEach var="element" items='${requestScope["listProducer"]}' varStatus="stt">
                    <tr>
                        ...
                        <td> <li><a href="/ProducerServlet?action=delete&id=${element.getId()}"><button type="button" class="btn btn-primary">Delete</button> </a></li></td>
                         <td>   <li><a href="/ProducerServlet?action=update&id=${element.getId()}"><button type="button" class="btn btn-primary">Update</button></a></li></td>
                ...
                <td>
                    <div class="dropdown dropend">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/ProducerServlet?action=delete&id=${element.getId()}"><button type="button" class="btn btn-primary">Delete</button> </a></li>
                            <li><a href="/ProducerServlet?action=update&id=${element.getId()}"><button type="button" class="btn btn-primary">Update</button></a></li>
                        </ul>
                    </div>
                </td>
            </tr>
...
<%--        <td>${element.isStatus()}</td>--%>
<%--        <td colspan="2">--%>
<%--            <a href="/ProducerServlet?action=update&id=${element.getId()}"><button type="button>">Update</button> </a>--%>
<%--            <a href="/ProducerServlet?action=delete&id=${element.getId()}"><button type="button">Delete</button> </a>--%>
<%--        </td>--%>
<%--    </tr>--%>
<%--    </c:forEach>--%>
<%--    </table>--%>
