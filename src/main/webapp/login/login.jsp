...
<div class="login-wrap">
  ...
  <div class="signup-callout">
    Need an account? <a href="http://localhost:63342/bookManager/bookManager.main/webapp/login/SignUp.html?_ijt=iu0453l4vcc5m31feavli9vpm2&_ij_reload=RELOAD_ON_SAVE">Sign up now!</a>
  </div>
</div>
</body>
</html>